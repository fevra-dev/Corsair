...
class CrossOriginIsolationAnalyzer(BaseAnalyzer):
    ...
    ADDITIONAL_HEADERS = ["Cross-Origin-Embedder-Policy", "Cross-Origin-Resource-Policy"]
    ...
    def _check_isolation_status(self, coop: Optional[str], coep: Optional[str]) -> List[Finding]:
        """
