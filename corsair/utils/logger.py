...
def log_scan_complete(
    logger: logging.Logger, url: str, score: int, grade: str, duration_ms: int, findings_count: int
) -> None:
    """
...
def log_finding(
    logger: logging.Logger, header: str, severity: str, title: str, analyzer: str = None
) -> None:
    """
