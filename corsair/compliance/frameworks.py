...
class ComplianceMapper:
    ...
    def generate_summary(self, findings: List[Finding]) -> Dict[str, Dict[str, str]]:
        """
            ...
            for req_id, req_data in framework_reqs.items():
                ...
                if not req_findings:
                    ...
                    if req_data.get("headers"):
                        ...
                        pass_headers = {f.header for f in findings if f.severity == Severity.PASS}
    ...
    def get_failed_requirements(self, findings: List[Finding]) -> List[Dict]:
